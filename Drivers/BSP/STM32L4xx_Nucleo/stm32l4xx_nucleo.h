...
#define BUS_USART3_TX_GPIO_CLK_ENABLE() __HAL_RCC_GPIOC_CLK_ENABLE()
#define BUS_USART3_TX_GPIO_CLK_DISABLE() __HAL_RCC_GPIOC_CLK_DISABLE()
#define BUS_USART3_TX_GPIO_AF GPIO_AF7_USART3
#define BUS_USART3_TX_GPIO_PORT GPIOC
#define BUS_USART3_TX_GPIO_PIN GPIO_PIN_4
