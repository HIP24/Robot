...
char Acceleration[MAX_BUF_SIZE];
char Gyroscope[MAX_BUF_SIZE];
char Magnetometer[MAX_BUF_SIZE];
char Temperature[MAX_BUF_SIZE];
char Humidity[MAX_BUF_SIZE];
char Pressure[MAX_BUF_SIZE];
...
//		USB_Write(dataOut);
//
//		if (IKS01A3_MOTION_SENSOR_GetOutputDataRate(Instance, MOTION_ACCELERO,
//				&odr)) {
...
//		//printf("%s", dataOut);
//
//		if (IKS01A3_MOTION_SENSOR_GetFullScale(Instance, MOTION_ACCELERO,
//				&fullScale)) {
...
//		USB_Write(dataOut);
//
//		if (IKS01A3_MOTION_SENSOR_GetOutputDataRate(Instance, MOTION_GYRO,
//				&odr)) {
//			snprintf(dataOut, MAX_BUF_SIZE, "ODR[%d]: ERROR\r\n",
//					(int) Instance);
//		} else {
...
//		USB_Write(dataOut);
//
//		if (IKS01A3_MOTION_SENSOR_GetFullScale(Instance, MOTION_GYRO,
//				&fullScale)) {
//			snprintf(dataOut, MAX_BUF_SIZE, "FS[%d]: ERROR\r\n",
//					(int) Instance);
//		} else {
...
//		USB_Write(dataOut);
//
//		if (IKS01A3_MOTION_SENSOR_GetOutputDataRate(Instance, MOTION_MAGNETO,
//				&odr)) {
//			snprintf(dataOut, MAX_BUF_SIZE, "ODR[%d]: ERROR\r\n",
//					(int) Instance);
//		} else {
...
//		USB_Write(dataOut);
//
//		if (IKS01A3_MOTION_SENSOR_GetFullScale(Instance, MOTION_MAGNETO,
//				&fullScale)) {
//			snprintf(dataOut, MAX_BUF_SIZE, "FS[%d]: ERROR\r\n",
//					(int) Instance);
//		} else {
...
//		USB_Write(dataOut);
//
//		if (IKS01A3_ENV_SENSOR_GetOutputDataRate(Instance, ENV_TEMPERATURE,
//				&odr)) {
//			snprintf(dataOut, MAX_BUF_SIZE, "ODR[%d]: Error\r\n",
//					(int) Instance);
//		} else {
...
//		USB_Write(dataOut);
//
//		if (IKS01A3_ENV_SENSOR_GetOutputDataRate(Instance, ENV_PRESSURE,
//				&odr)) {
//			snprintf(dataOut, MAX_BUF_SIZE, "ODR[%d]: Error\r\n",
//					(int) Instance);
//		} else {
...
//		USB_Write(dataOut);
//
//		if (IKS01A3_ENV_SENSOR_GetOutputDataRate(Instance, ENV_HUMIDITY,
//				&odr)) {
//			snprintf(dataOut, MAX_BUF_SIZE, "ODR[%d]: Error\r\n",
//					(int) Instance);
//		} else {
